(function(root,factory){
  ...
  if(typeof module==="object"&&module.exports)module.exports=api;
    ...
    root.CNABBankDefinitions["341"]=root.CNABBankDefinitions["341"]||{};
    root.CNABBankDefinitions["341"]["086"]=api;
  }
      ...
      "fields": [
        {
          ...
          "observations": [
            {
              "kind": "fixed",
              "title": "Caractere fixo ou constante",
              "text": "341",
              "manualPage": 9
            }
          ]
        ...
        },
        {
          ...
          "observations": [
            {
              "kind": "fixed",
              "title": "Preenchimento fixo",
              "text": "Preencher integralmente com espaços em branco.",
              "manualPage": 9
            }
          ]
        },
        ...
        },
        {
          ...
          "picture": "9(01)",
          "content": "1 = CPF; 2 = CNPJ",
          "observations": [
            {
              "kind": "info",
              "title": "Regra do layout",
              "text": "1 = CPF; 2 = CNPJ",
              "manualPage": 9
            }
          ]
        ...
        },
        {
          ...
          "picture": "9(01)",
          "content": "1 = REMESSA; 2 = RETORNO",
          "observations": [
            {
              "kind": "info",
              "title": "Regra do layout",
              "text": "1 = REMESSA; 2 = RETORNO",
              "manualPage": 9
            }
          ]
        },
          ...
          "observations": [
            {
              "kind": "fixed",
              "title": "Preenchimento fixo",
              "text": "Preencher integralmente com zeros.",
              "manualPage": 9
            }
          ]
        },
      ...
      "fields": [
        ...
        },
        {
          ...
          "observations": [
            ...
            {
              "kind": "info",
              "title": "Observação (1) do layout",
              "text": "Quando se tratar de lote para financiamento de Bens e Serviços (COMPROR/FINABS) ou Desconto de NPR (Crédito Rural), previamente contratado junto ao banco, o conteúdo deste campo deve ser identificado pela letra \"F\". Esta sistemática só se aplica ao Pagamento de Fornecedores, tipo 20, cuja forma seja crédito em Conta Corrente, DOC e TED.",
              "manualPage": 10
            }
          ]
        },
        {
          ...
          "observations": [
            ...
            {
              "kind": "info",
              "title": "Observação (3) do layout",
              "text": "Quando se tratar de “Informe de Rendimentos”, utilizar nestes campos conteúdo “30” para Tipo de Pagamento e “01” para Forma de Pagamento. Para operações de débito/crédito em Conta Investimento utilizar somente Formas de Pagamento “06” (crédito em conta de mesma titularidade) ou “43” (TED – mesmo titular). Especificamente para movimentações envolvendo Conta Investimento, os pagamentos na forma de TED de mesma titularidade podem ser de qualquer valor, inclusive inferior ao limite estabelecido pelo Banco Central do Brasil.",
              "manualPage": 10
            }
          ]
        },
        ...
        },
        {
          ...
          "meaning": "IDENTIFICAÇÃO DO LANÇAMENTO NO EXTRATO DO FAVORECIDO",
          "picture": "X(04)",
          "content": "NOTA 13",
          "observations": [
            {
        ...
        },
        {
          ...
          "observations": [
            ...
            {
              "kind": "info",
              "title": "Observação (2) do layout",
              "text": "Sempre que o serviço for referente à “Holerite - Demonstrativo de Pagamentos / Informe de Rendimentos” e débito em Conta Investimento, deverá ser indicado na posição 103 a 104 o código correspondente, conforme Nota 6 deste manual;",
              "manualPage": 10
            }
          ]
        },
        ...
        },
        {
          ...
          "observations": [
            ...
            {
              "kind": "info",
              "title": "Observação (*) do layout",
              "text": "Campos que constam apenas no arquivo retorno. Na remessa, devem ser informados com brancos ou zeros, conforme a picture de cada campo.",
              "manualPage": 10
            }
          ]
        }
    ...
    "segmento_a": {
      ...
      "fields": [
        ...
        },
        {
          ...
          "observations": [
            ...
            },
            {
              "kind": "info",
              "title": "Observação (1) do layout",
              "text": "Quando se tratar especificamente de “Informe de Rendimentos”, o campo “DATA DE PGTO” deve ser preenchido com uma data maior ou igual à de envio do arquivo ao Banco (limitado a 360 dias); e o campo “VALOR DO PAGTO” deve ser informado com zeros.",
              "manualPage": 12
            }
          ]
        },
        ...
        },
        {
          "start": 218,
          "end": 219,
          "name": "FINALIDADE DOC E STATUS FUNCIONÁRIO",
          "meaning": "FINALIDADE DO DOC E STATUS DO FUNCIONÁRIO NA EMPRESA",
          "picture": "X(02)",
          "content": "NOTA 30",
          "observations": [
            {
        ...
        },
        {
          ...
          "observations": [
            ...
            },
            {
              "kind": "info",
              "title": "Observação (2) do layout",
              "text": "Para Conta Investimento utilizar Finalidade “00016”, conforme descrito na Nota 26, inclusive quando se tratar de pagamento na forma de crédito em conta corrente de mesma titularidade.",
              "manualPage": 12
            }
          ]
        },
        ...
        },
        {
          ...
          "observations": [
            ...
            },
            {
              "kind": "info",
              "title": "Observação (*) do layout",
              "text": "Para pagamento através de TED para Corretoras, por determinação do BACEN é obrigatória a identificação da Câmara e do Código ISPB na remessa conforme descrito na Nota 35. Para pagamento através de TED para Conta Pagamento, por determinação do BACEN é obrigatória identificação do Código ISPB na remessa conforme descrito na Nota 35 e Complemento de Registro conforme descrito na Nota 36. Por se tratar de complemento, este registro pode ser apresentado na remessa e não constará no arquivo retorno, exceto quando utilizado o serviço de “Demonstrativo de Pagamentos”.",
              "manualPage": 15
            }
          ]
        }
    ...
    "segmento_b_pix": {
      ...
      "fields": [
        ...
        },
        {
          "start": 63,
          "end": 127,
          "name": "INFORMAÇÕES ENTRE USUÁRIOS",
    ...
    "segmento_d": {
      ...
      "fields": [
        ...
        },
        {
          ...
          "meaning": "PRAZO PARA DISPONIBILIZAÇÃO DO HOLERITE",
          "picture": "X(02)",
          "content": "NOTA 27",
          "observations": [
            {
    ...
    "segmento_e": {
      ...
      "fields": [
        ...
        },
        {
          ...
          "meaning": "INFORMAÇÕES COMPLEMENTARES PARA HOLERITE OU INFORME DE RENDIMENTOS",
          "picture": "X(200)",
          "content": "ANEXO D",
          "observations": [
            {
    ...
    "segmento_f": {
      ...
      "fields": [
        ...
        },
        {
          "start": 18,
          "end": 161,
          "name": "MENSAGEM / INFORMAÇÕES COMPLEMENTARES",
          "meaning": "DESCRIÇÃO DA MENSAGEM / INFORMAÇÕES COMPLEMENTARES",
          "picture": "X(144)",
          "content": "NOTA 25",
          "observations": [
            {
        ...
        },
        {
          ...
          "observations": [
            ...
            },
            {
              "kind": "info",
              "title": "Observação (1) do layout",
              "text": "Quando se tratar de “Informe de Rendimentos”, informar este campo com zeros.",
              "manualPage": 22
            }
          ]
        },
        ...
        },
        {
          ...
          "observations": [
            ...
            },
            {
              "kind": "info",
              "title": "Observação (1) do layout",
              "text": "Quando se tratar de lote para financiamento de Bens e Serviços (COMPROR/FINABS) ou Desconto de NPR (Crédito Rural), previamente contratado junto ao banco, o conteúdo deste campo deve ser identificado pela letra \"F\". Esta sistemática só se aplica ao Pagamento de Fornecedores, tipo 20.",
              "manualPage": 23
            }
          ]
        },
    ...
    "segmento_j52": {
      ...
      "fields": [
        ...
        },
        {
          "start": 76,
          "end": 76,
          "name": "TIPO DE INSCRIÇÃO CEDENTE",
          ...
          "observations": [
            {
              "kind": "info",
              "title": "Observação (1) do layout",
              "text": "Campos exclusivos para pagamento de GARE – SP ICMS, demais Tributos devem ser preenchidos com brancos ou zeros, de acordo com a picture.",
              "manualPage": 37
            }
          ]
        },
          ...
          "observations": [
            {
              "kind": "info",
              "title": "Observação (2) do layout",
              "text": "Campo exclusivo para pagamento de GARE – SP ICMS, demais Tributos devem ser preenchidos com brancos ou zeros, de acordo com a picture.",
              "manualPage": 37
            }
          ]
        },
        ...
        },
        {
          ...
          "observations": [
            ...
            },
            {
              "kind": "info",
              "title": "Observação (1) do layout",
              "text": "Este campo deve ser utilizado para informar o somatório dos pagamentos do tributo GPS – Guia da Previdência Social, e o somatório do campo “DESCONTO” quando se tratar de pagamentos de IPVA.",
              "manualPage": 40
            }
          ]
        },
  ...
  "notes": {
    "1": "(1) IDENTIFICAÇÃO DO CNPJ E AG/CONTA Num mesmo arquivo podem ser comandados débitos em diferentes contas da empresa / grupo: • No registro Header de Arquivo identificar a empresa \"Mãe\" do grupo ou a matriz; • No registro Header de Lote identificar a empresa e a agência/conta que receberá o débito; • A identificação deve se repetir quando for única.",
    "2": "(2) UNIDADE DE DENSIDADE Para teleprocessamento esse campo deverá conter zeros.",
    "3": "(3) CÓDIGO DO LOTE Identifica o Lote de Pagamentos. É seqüencial, iniciando-se em 0001. Todos os pagamentos de um lote devem ter o mesmo \"Código de Lote\".",
    "4": "(4) TIPO DE PAGAMENTO Indica o tipo de pagamento que o lote contém. 10 DIVIDENDOS 15 DEBÊNTURES 20 FORNECEDORES 22 TRIBUTOS 30 SALÁRIOS 40 FUNDOS DE INVESTIMENTOS 50 SINISTROS DE SEGUROS 60 DESPESAS VIAJANTE EM TRÂNSITO 80 REPRESENTANTES AUTORIZADOS 90 BENEFÍCIOS 98 DIVERSOS",
    "5": "(5) FORMA DE PAGAMENTO Indica a forma de pagamento que o lote contém. Verifique na tabela da página 4 a compatibilidade entre o tipo e a forma de pagamento. 01 CRÉDITO EM CONTA CORRENTE NO ITAÚ 02 CHEQUE PAGAMENTO/ADMINISTRATIVO 03 DOC “C” 05 CRÉDITO EM CONTA POUPANÇA NO ITAÚ 06 CRÉDITO EM CONTA CORRENTE DE MESMA TITULARIDADE 07 DOC “D” 10 ORDEM DE PAGAMENTO À DISPOSIÇÃO 13 PAGAMENTO DE CONCESSIONÁRIAS 16 DARF NORMAL 17 GPS - GUIA DA PREVIDÊNCIA SOCIAL 18 DARF SIMPLES 19 IPTU/ISS/OUTROS TRIBUTOS MUNICIPAIS 22 GARE – SP ICMS 25 IPVA 27 DPVAT 30 PAGAMENTO DE TÍTULOS EM COBRANÇA NO ITAÚ 31 PAGAMENTO DE TÍTULOS EM COBRANÇA EM OUTROS BANCOS 32 NOTA FISCAL – LIQUIDAÇÃO ELETRÔNICA 35 FGTS 41 TED – OUTRO TITULAR 43 TED – MESMO TITULAR 45 PIX TRANSFERÊNCIA 47 PIX QR-CODE 60 CARTÃO SALÁRIO 91 GNRE E TRIBUTOS COM CÓDIGO DE BARRAS Observação: Normalmente pagamentos inconsistentes são rejeitados, conforme nota 8. Excepcionalmente, na contratação pode ser acertada a geração de uma Ordem de Pagamento destinada à agência debitada, quando um pagamento (exceto pagamento de títulos, concessionárias, DARF, DARF Simples, DARJ, GARE – SP ICMS, GPS, IPTU, IPVA e DPVAT) tiver sido rejeitado pelo Itaú; neste caso, no arquivo retorno, este campo será preenchido com o código 11 - Ordem de Pagamento para Acerto. Para o tipo de pagamento “30 salário” deverá utilizar exclusivamente a forma TEF (transferência entre contas). Caso envie pagamentos de salários via DOC, TED, OP e Cheque OP, os mesmos serão rejeitados e o arquivo retorno seguirá com a seguinte descrição (tabela Nota 08): Código Descrição IM TIPO X FORMA NÃO COMPATIVEL",
    "6": "(6) FINALIDADE DO LOTE Na contratação, não tendo sido acertada a sua utilização, este campo deverá ser obrigatoriamente preenchido com brancos. Se contratado, a mensagem constará em todos os avisos e documentos originados do lote, desde que seja solicitado aviso ao favorecido conforme nota 16. Quando se tratar de Conta de Investimento ou o tipo de pagamento for SISPAG Salários e tiver sido contratado o serviço Holerite – Demonstrativo de Pagamentos / Informe de Rendimentos, via Itaú Empresas na Internet / Auto-Atendimento, deverá ser indicado nas posições 103 a 104 o código correspondente, conforme tabela abaixo: Código Descrição 01 Folha Mensal 02 Folha Quinzenal 03 Folha Complementar 04 13º Salário 05 Participação de Resultados 06 Informe de Rendimentos 07 Férias 08 Rescisão 09 Rescisão Complementar 10 Outros 85 Débito Conta Investimento Para pagamentos que envolvam Conta Investimento os campos Finalidade do Lote (Posições 103 e 104 do Registro Header de Lote) e Finalidade TED (Posições 220 a 224 do Registro Detalhe Segmento A - Nota 26), devem apresentar os seguintes conteúdos, de acordo com a operação: DÉBITO CRÉDITO FINALIDADE DO LOTE FINALIDADE TED CONTA CORRENTE CONTA CORRENTE “00” “00000” ou brancos (forma de pagamento “06”) CONTA CORRENTE CONTA INVESTIMENTO “00” “00016” (formas de pagamento “06” ou “43”) CONTA INVESTIMENTO CONTA CORRENTE “85” “00000” ou brancos (formas de pagamento “06” ou “43”) CONTA INVESTIMENTO CONTA INVESTIMENTO “85” “00016” (formas de pagamento “06” ou “43”)",
    ...
    "28": "(28) OPÇÃO DE PAGAMENTO Indica as opções para quitação do imposto: Código Descrição 0 Pagamento de DPVAT 1 Parcela Única com desconto 2 Parcela Única sem desconto 3 Parcela Nº 1 4 Parcela Nº 2 5 Parcela Nº 3 6 Parcela Nº 4 7 Parcela Nº 5 8 Parcela Nº 6 OBS.: O código de opção “2” não se aplica para pagamentos do IPVA MG.",
    ...
    "42": "(42) COMPLEMENTO DE REGISTRO Número de Agência para conta pagamento (opcional)."
  }
};});
